...
public class GrabbingHand : MonoBehaviour
{
	...
	protected void StartPinch()
	{
		...
		palm_rotation_ = GetPalmRotation( hand );
		object_pinch_offset_ = Vector3.zero;
	...
	protected void UpdatePinchPosition()
	{
		...
		current_pinch_position_ = 0.5f * tipvec;
	...
	protected void UpdatePalmRotation()
	{
        ...
        palm_rotation_ = Quaternion.Slerp( palm_rotation_, rot,
	...
	private Quaternion GetPalmRotation( Hand hand )
	{
		//Vector handdirection = ( hand.PalmNormal - hand.PalmPosition ).Normalized;
		//Vector3 vector;
		//{
		//	vector.x = handdirection.x;
		//	vector.y = handdirection.y;
		//	vector.z = handdirection.z;
		//}
		//return Quaternion.LookRotation( vector );
		return PalmRotation.rotation;
    }
}
